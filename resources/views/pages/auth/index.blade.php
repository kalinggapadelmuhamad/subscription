            ...
            <section class="section">
                <div class="d-flex align-items-stretch flex-wrap m-0">
                    <div
                        ...
                        <div class="p-3 m-3">
                            <h1 class="text-dark font-weight-bold">Login
                            </h1>
                            <p class="text-muted">Please login using your credentials account.
                                <span class="text-white">sssssssssssssssss</span>
                            </p>
                            ...
                            <div class="text-small mt-5 text-center">
                                Copyright &copy; 2024 <br> Login Page
                            </div>
                        </div>
                    </div>
                    <div
